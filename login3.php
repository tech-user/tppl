...
<div class="container">
  <div class="row">
      <div class="col-sm-12">
        <h1 style="color:#56B681; text-align:center; margin-top:5%;">Production Online</h1>
      </div>
...
<div class="col-sm-6" align="center" style="padding-top:50px;">
        ...
        <form class="form" style="width:60%;" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
          ...
          <div class="form-group form-group-lg" <?php echo (!empty($password_err)) ? 'has-error' : ''; ?>>
            <input type="password" class="form-control" name="password" placeholder="Password" style="border:2px solid #4A4A4A; background-color:#252F37; color:#56B681;">
